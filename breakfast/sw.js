const CACHE_NAME = 'brk365-v6';
const STATIC = ['/breakfast/', '/breakfast/index.html', '/breakfast/data.js', '/breakfast/manifest.json', '/breakfast/icon-192.png', '/breakfast/icon-512.png', 'https://cdn.tailwindcss.com'];
